methods {
    ...
    function royaltiesForCollection(uint256, uint256) external returns (address, uint96) envfree;
...
rule creatingCollectionIncrementsCounter(env e) {
    ...
    string name; string symbol; string uri; string d;
    LibShare.Share[] royalties;
    uint256 newId = createCollection(e, name, symbol, uri, d, royalties);
