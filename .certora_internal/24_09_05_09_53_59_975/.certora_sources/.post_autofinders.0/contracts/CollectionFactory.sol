    ...
    UUPSUpgradeable
{
    ...
    ) public logInternal16(_collectionMethodAddress,_piNFTMethodsAddress)initializer {
        __Ownable_init();
        __UUPSUpgradeable_init();
        __Pausable_init();
        collectionMethodAddress = _collectionMethodAddress;
        piNFTMethodsAddress = _piNFTMethodsAddress;
    }modifier logInternal16(address _collectionMethodAddress,address _piNFTMethodsAddress) { assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00100000, 1037618708496) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00100001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00101000, _collectionMethodAddress) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00101001, _piNFTMethodsAddress) } _; }
    ...
    ) public logInternal8(_name,_symbol,_uri,_description,royalties)whenNotPaused returns (uint256 collectionId_) {
    ...
    }modifier logInternal8(string memory _name,string memory _symbol,string calldata _uri,string memory _description,LibShare.Share[] memory royalties) { assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00080000, 1037618708488) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00080001, 6) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00081000, _name) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00081001, _symbol) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00083002, _uri.offset) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00082002, _uri.length) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00081003, _description) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00081004, royalties) } _; }
    ...
    function setRoyaltiesForCollection(
        ...
        LibShare.Share[] memory royalties
    ) public logInternal15(_collectionId,royalties)whenNotPaused collectionOwner(_collectionId) {
    ...
    }modifier logInternal15(uint256 _collectionId,LibShare.Share[] memory royalties) { assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000f0000, 1037618708495) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000f0001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000f1000, _collectionId) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000f1001, royalties) } _; }
    ...
    function setCollectionURI(
        uint256 _collectionId,
        string calldata _uri
    ) public logInternal13(_collectionId,_uri)whenNotPaused collectionOwner(_collectionId) {
        if (
    ...
    }modifier logInternal13(uint256 _collectionId,string calldata _uri) { assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000d0000, 1037618708493) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000d0001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000d1000, _collectionId) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000d3001, _uri.offset) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000d2001, _uri.length) } _; }
    ...
    function setCollectionName(
        uint256 _collectionId,
        string memory _name
    ) public logInternal19(_collectionId,_name)whenNotPaused collectionOwner(_collectionId) {
        if (
    ...
    }modifier logInternal19(uint256 _collectionId,string memory _name) { assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00130000, 1037618708499) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00130001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00131000, _collectionId) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00131001, _name) } _; }
    ...
    function setCollectionSymbol(
        uint256 _collectionId,
        string memory _symbol
    ) public logInternal18(_collectionId,_symbol)whenNotPaused collectionOwner(_collectionId) {
        if (
    ...
    function setCollectionDescription(
        uint256 _collectionId,
        string memory _description
    ) public logInternal9(_collectionId,_description)whenNotPaused collectionOwner(_collectionId) {
        if (
    ...
    function _authorizeUpgrade(address) internal override logInternal7()onlyOwner {}modifier logInternal7(address ) { assembly { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00070000, 1037618708487) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00070001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00075000, 0) } _; }
}
