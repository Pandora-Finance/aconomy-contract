methods {
    // CollectionMethods contract methods
...
rule onlyMethodsCanSetValidatorRoyalties(uint256 tokenId, uint256 commission, LibShare.Share[] royalties) {
    env e;
    address piNFTMethodsAddress = CollectionFactory.piNFTMethodsAddress(e);
