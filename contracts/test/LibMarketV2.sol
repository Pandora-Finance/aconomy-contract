...
library LibMarketV2 {
     ...
     */
    function checkSale(piMarketV2.TokenMeta storage meta) external view {
        require(meta.status);
    ...
    function executeSale(
        piMarketV2.TokenMeta storage meta,
    ...
    function executeBid(
        piMarketV2.TokenMeta storage meta,
        piMarketV2.BidOrder storage bids,
        LibShare.Share[] memory royalties,
        LibShare.Share[] memory validatorRoyalties,
        address piNFTMethodsAddress,
        address AconomyFeeAddress
    ...
    function callV2() external pure returns(bool){
        return true;
    }
}
