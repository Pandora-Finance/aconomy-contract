...
import "./LibMarketV2.sol";

contract piMarketV2 is
    ...
    UUPSUpgradeable
{
    ...
    function BuyNFT(
        ...
        LibMarketV2.checkSale(_tokenMeta[_saleId]);

        LibMarketV2.executeSale(
            _tokenMeta[_saleId],
            feeAddress,
            piNFTMethodsAddress,
            royalties,
    ...
    function Bid(
        ...
        LibMarketV2.checkBid(_tokenMeta[_saleId], _bidPrice);
    ...
    function withdrawBidMoney(
        ...
        LibMarketV2.withdrawBid(_tokenMeta[_saleId], Bids[_saleId][_bidId]);
    ...
    function setNumber(uint8 _number) external returns(string memory){
        number = _number;
        bool libraryCheck = LibMarketV2.callV2();
        require(libraryCheck);
        return 'hi';
    } 
