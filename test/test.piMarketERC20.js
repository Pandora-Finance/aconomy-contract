...
contract("PiMarket", async (accounts) => {
    ...
    describe("Direct Sale", () => {
        ...
        it("should let alice place piNFT on sale", async () => {
            ...
            const result = await piMarket.sellNFT(piNFT.address, 0, 50000, sampleERC20.address);
            assert.equal(
    ...
    describe("Auction sale", () => {
        ...
        it("should let alice place piNFT on auction", async () => {
            ...
            const tx = await piMarket.SellNFT_byBid(piNFT.address, 1, 50000, 300, sampleERC20.address);
            assert.equal(
