...
describe("piMarketERC20", function () {
    ...
    describe("Direct Sale", function () {
        ...
        it("should not place nft on sale if price < 10000", async () => {
            ...
            await expect(
                piMarket.sellNFT(piNFT.getAddress(), 0, 100, sampleERC20.getAddress())
        ...
        it("should let bob place piNFT on sale", async () => {
            ...
            const result = await piMarket
                .connect(bob)
                .sellNFT(piNFT.getAddress(), 0, 50000, sampleERC20.getAddress());
            expect(await piNFT.ownerOf(0)).to.equal(await piMarket.getAddress());
        });
        ...
        it("should let bob place piNFT on sale again", async () => {
            ...
            await piMarket
                .connect(bob)
                .sellNFT(piNFT.getAddress(), 0, 10000, sampleERC20.getAddress());
            expect(await piNFT.ownerOf(0)).to.equal(await piMarket.getAddress());
        });
    ...
    describe("Auction sale", () => {
        ...
        it("should allow validator to add erc20 and change commission and royalties", async () => {
            ...
            await piNftMethods
                .connect(validator)
                .addERC20(piNFT.getAddress(), 1, sampleERC20.getAddress(), 500, exp.toString(), 100, [
                    [validator.getAddress(), 300],
                ]);
            let commission = await piNftMethods.validatorCommissions(
                piNFT.getAddress(),
    ...
    describe("Sale Test", function () {
        it("should create a piNFT with 500 erc20 tokens to carl", async () => {
          ...
          const tx = await piNftMethods
            .connect(validator)
            .addERC20(piNFT.getAddress(), 2, sampleERC20.getAddress(), 500, exp.toString(), 0, [
              [validator.getAddress(), 200],
            ]);
        ...
        it("should create a piNFT with 500 erc20 tokens to carl", async () => {
            ...
            const tx = await piNftMethods
              .connect(validator)
              .addERC20(piNFT.getAddress(), 3, sampleERC20.getAddress(), 500, exp.toString(), 0, [
                [validator.getAddress(), 200],
              ]);
