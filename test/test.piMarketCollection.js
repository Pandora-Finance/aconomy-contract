...
contract("PiMarket", async (accounts) => {
    ...
    describe("Direct Sale", () => {
        ...
        it("should let alice place piNFT on sale", async () => {
            ...
            const result = await piMarket.sellNFT(collectionContract.address, 0, 5000, "0x0000000000000000000000000000000000000000");
            assert.equal(
    ...
    describe("Auction sale", () => {
        ...
        it("should let alice place piNFT on auction", async () => {
            ...
            const tx = await piMarket.SellNFT_byBid(collectionContract.address, 1, 5000, 300, "0x0000000000000000000000000000000000000000");
            assert.equal(
        ...
        it("should let alice place piNFT on auction", async () => {
            ...
            const tx = await piMarket.SellNFT_byBid(collectionContract.address, 2, 5000, 300, "0x0000000000000000000000000000000000000000");
            assert.equal(
